...
# or have the split pancancer matrix files ready in 3_DataProcessing folder
# Setup environment
rm(list=ls())
...
Log_file = paste0("./1_Log_Files/", download.method, "/3.1_Consensus_Clustering/3.1_Consensus_Clustering_Log_File_",                          # Specify complete name of the logfile that will be saved during this script
...
for (i in 1:N.sets) {
  ...
  load(paste0("./3_DataProcessing/Assembler_Panca_Normalized", "/", Cancer, "/RNASeqData/", Cancer, "_gene_RNAseq_normalized_Tissue_Type_and_whitelists_filtered.Rdata"))
