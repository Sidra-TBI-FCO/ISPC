...
png(paste0("./5_Figures/ICR_distribution_plots/ICR_boxplot_across_cancers/", 
           download.method, "/3.14.ICR_distribution_boxplot_ordered_by_", basis_ordering, "_", ICR_classification_k,
           "_colour_by_cancer_across_cancers_Skipped_", Cancer_skip,".png"), res=600,height=6,width=15,unit="in")
boxplot_ICR = ggplot(data = ICR_cluster_assignment_allcancers, aes(x= HML_cluster, y= ICRscore, fill = Cancer)) +
  ...
  theme(panel.background = element_rect(fill = "white"),
        ...
        strip.text.x = element_text(colour = "black", angle = 90)) +
...
png(paste0("./5_Figures/ICR_distribution_plots/ICR_boxplot_across_cancers/", 
           download.method, "/final_3.14.ICR_distribution_boxplot_ordered_by_", basis_ordering, "_", ICR_classification_k,
           "_colour_by_ICR_cluster_across_cancers_skipped_", Cancer_skip ,".png"), res=600,height=6,width=15,unit="in")
boxplot_ICR = ggplot(data = ICR_cluster_assignment_allcancers, aes(x= HML_cluster, y= ICRscore, fill = HML_cluster)) +
  ...
  theme(panel.background = element_rect(fill = "white"),
        ...
        strip.text.x = element_text(colour = "black", size = 20, angle = 90),
...
save(ICR_cluster_assignment_allcancers, Cancer_color_table, file =paste0("./4_Analysis/", download.method, "/Pan_Cancer/Clustering/ICR_cluster_assignment_allcancers_Skipped_", 
                                                                         Cancer_skip, ".Rdata"))
...
png(paste0("./5_Figures/ICR_distribution_plots/ICR_boxplot_across_cancers/", 
           download.method, "/3.14.ICR_distribution_boxplot_ordered_by_", basis_ordering, "_Mean_ICR",
           "_colour_by_cancer_across_cancers_Skipped_", Cancer_skip,".png"), res=600,height=6,width=15,unit="in")
